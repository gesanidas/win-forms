...
namespace sifnos1
{
    public partial class Elies : AbstractHotelForm
    {
        ...
        private void Elies_Load(object sender, EventArgs e)
        {
            check_and_save();
            pictureBox1.BackgroundImage = Image.FromFile("ArxaioiPurgoi-1.jpg");
            pictureBox1.BackgroundImageLayout = ImageLayout.Stretch;
            pictureBox1.BorderStyle = BorderStyle.FixedSingle;
            label11.Text = "Το Elies Resorts δημιουργήθηκε στη Σίφνο με τη φιλοδοξία να αποτελέσει\nσημείο αναφοράς σε εγχώριο αλλά και παγκόσμιο επίπεδο. Έτσι σχεδιάστηκε\nένα ιδιαίτερα πολυτελές ξενοδοχειακό συγκρότημα με τις υψηλότερες δυνατές\nπροδιαγραφές και παράλληλα με απόλυτο σεβασμό στην παραδοσιακή\nαρχιτεκτονική και με την μικρότερη δυνατή επέμβαση στο φυσικό τοπίο,\nαναδεικνύοντας με αυτό τον τρόπο το χαρακτήρα του νησιού.";
