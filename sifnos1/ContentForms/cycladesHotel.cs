...
namespace sifnos1
{
    public partial class cycladesHotel : AbstractHotelForm
    {
        private int photoID = 1;
        private int bigPhotoID;

        public cycladesHotel()
        {
            InitializeComponent();
        }

        private void cycladesHotel_Load(object sender, EventArgs e)
        {
            check_and_save();
            pictureBox1.BackgroundImage = Image.FromFile("ArxaioiPurgoi-1.jpg");
            pictureBox1.BackgroundImageLayout = ImageLayout.Stretch;
            pictureBox1.BorderStyle = BorderStyle.FixedSingle;
            label11.Text = "Το συγκρότημά μας βρίσκεται στον Πλατύ Γιαλό της Σίφνου, αποτελείται από\n6 διαμερίσματα και 2 δωμάτια τα οποία βρίσκονται σε απόσταση 35 μέτρων από\nτη θάλασσα και διαθέτει ιδιόκτητο πάρκινγκ.";
        }
