...
namespace sifnos1
{
    public partial class Iliovasilemacs : AbstractRestaurantForm
    {
        ...
        public Iliovasilemacs()
        {
            InitializeComponent();
        }

        private void Iliovasilemacs_Load(object sender, EventArgs e)
        {
            check_and_save();
            pictureBox1.BackgroundImage = Image.FromFile("ArxaioiPurgoi-1.jpg");
            pictureBox1.BackgroundImageLayout = ImageLayout.Stretch;
            pictureBox1.BorderStyle = BorderStyle.FixedSingle;
            label11.Text = "Ψητά και πιάτα φτιαγμένα με φροντίδα, με φρέσκα\nντόπια κρεατικά και λαχανικά δικής μας παραγωγής.\nΣας καλωσορίζουμε στο \"Ηλιοβασίλεμα\" όπου θα απολαύσετε Σιφνέικες\nπαραδοσιακές σπιτικές λιχουδιές και ντόπιο κρασί.\n\nΑνυπομονούμε να σας υποδεχθούμε στην ταβέρνα μας στο\nΤρουλλάκι για να γνωρίσετε και εσείς τη μαγεία της περιοχής.";
        }
