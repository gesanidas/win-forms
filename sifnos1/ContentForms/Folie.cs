...
namespace sifnos1
{
    public partial class Folie : AbstractBarForm
    {
        ...
        private void Folie_Load(object sender, EventArgs e)
        {
            check_and_save();
            pictureBox1.BackgroundImage = Image.FromFile("ArxaioiPurgoi-1.jpg");
            pictureBox1.BackgroundImageLayout = ImageLayout.Stretch;
            pictureBox1.BorderStyle = BorderStyle.FixedSingle;
            label11.Text = "Μια υπέροχη βεράντα με ξαπλώστρες και η πιο καταπληκτική θέα των Καμαρών. \nΗ Αγία Μαρίνα βρίσκεται στην άλλη πλευρά του λιμανιού . \nΔοκιμάστε ένα κοκτέιλ μετά το ηλιοβασίλεμα !";
        }
