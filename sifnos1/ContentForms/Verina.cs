...
namespace sifnos1
{
    public partial class Verina : AbstractHotelForm
    {
        ...
        private void Verina_Load(object sender, EventArgs e)
        {
            check_and_save();
            pictureBox1.BackgroundImage = Image.FromFile("ArxaioiPurgoi-1.jpg");
            pictureBox1.BackgroundImageLayout = ImageLayout.Stretch;
            pictureBox1.BorderStyle = BorderStyle.FixedSingle;
            label11.Text = "Πολυτελή διαμερίσματα και σουίτες χτισμένα σύμφωνα με την τοπική\nαρχιτεκτονική μέσα σε έναν ελαιώνα λίγα βήματα από την παραλία στον Πλατύ Γιαλό.\nΧαλαρή ατμόσφαιρα και υψηλή ποιότητα φιλοξενίας.";
        }
