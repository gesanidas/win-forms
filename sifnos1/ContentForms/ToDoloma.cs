...
namespace sifnos1
{
    public partial class ToDoloma : AbstractBarForm
    {
        ...
        private void ToDoloma_Load(object sender, EventArgs e)
        {
            check_and_save();
            pictureBox1.BackgroundImage = Image.FromFile("ArxaioiPurgoi-1.jpg");
            pictureBox1.BackgroundImageLayout = ImageLayout.Stretch;
            pictureBox1.BorderStyle = BorderStyle.FixedSingle;
            label11.Text = "Το γνωστό σε όλους τους fan της διασκέδασης της Σίφνου, 'Δόλωμα'\nάνοιξε ξανά τις πόρτες του σε νέο ανανεωμένο χώρο.";
        }
