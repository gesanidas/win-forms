...
namespace sifnos1
{
    public partial class AbstractSightsForm : ContentForm
    {
        public AbstractSightsForm()
        {
            InitializeComponent();
        }
        ...
        {
            SightsMenuForm sights = new SightsMenuForm();
            sights.Show();
            this.Hide();
        }
        ...
        private void AbstractSightsForm_Load(object sender, EventArgs e)
        {
