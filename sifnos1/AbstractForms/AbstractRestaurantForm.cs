...
namespace sifnos1
{
    public partial class AbstractRestaurantForm : ContentForm
    {
        public AbstractRestaurantForm()
        {
            InitializeComponent();
        }
        ...
        {
            RestaurantsMenuForm rest = new RestaurantsMenuForm();
            rest.Show();
            this.Hide();
        }
        ...
        private void AbstractRestaurantForm_Load(object sender, EventArgs e)
        {
